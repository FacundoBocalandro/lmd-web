      ...
      <Card variant={"outlined"} className={"register-card"}>
        ...
        <div className={"register-form"}>
          ...
          <div className={"register-input-container"}>
            ...
            <span
              className={errors.lastName ? 'error-message' : 'error-message no-message'}> Error en el apellido</span>
          </div>
          <div className={"register-input-container"}>
          ...
          <div className={"register-input-container"}>
            ...
            <span
              className={errors.gender ? 'error-message' : 'error-message no-message'}>Debe seleccionar el sexo</span>
          </div>
          <div className={"register-input-container"}>
